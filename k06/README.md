...
77-90 表を初期化する
96-102 k＜arrayitem[i-1].priceまでは一つ上の状態を引き継ぐ
108-115　メニューそのままの時のカロリーと入れ替えたときのカロリーを比較し入れ替えた方が高い場合高いメニューのカロリーをプラスした値を入れる
120 最大取得可能のカロリー（表の一番右下の値）を出力
